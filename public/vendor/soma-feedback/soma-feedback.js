...
(function () {
  ...
  // SAME-ORIGIN BUILD (soma-feedback-proxy, 2026-08-10). Identical to the
  // canonical SOMA/standards/soma-feedback/soma-feedback.js except that the
  // default submission endpoint is a same-origin proxy function instead of
  // the shared service host. See ../../README.md for why: the cross-origin
  // default made one host a single point of failure for every chip in the
  // estate, and it took them all down at once on 2026-07-22.
  var DEFAULT_ENDPOINT = '/.netlify/functions/soma-feedback';
